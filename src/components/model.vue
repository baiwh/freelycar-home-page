<template>
  <div class="model">
    ...
    <pre class="model-info">小易智能柜的出现是真正解决了用户“洗车难”和商家洗车效率低问题的方案。小易智能柜对接的是基于标准汽车清洗流程的线下门店，不会存在类似上门洗车的清洗清洁度问题。
  ...
  而对于服务人员来说，工作时间可控，即便在早期单店的业务量不够的情况下，仍可选择一人服务多个门店的模式维持收入（基于夜间用户对用车时间的弹性，普通洗车店无法做到），获得远比普通洗车店员工高额的收入。
    </pre>
